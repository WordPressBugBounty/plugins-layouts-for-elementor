 ...
 *
 * Included from Layout_For_Elementor::lfe_render_layouts_page().
 *
 * @package LFE
 */
					...
					<div class="lfe_box lfe_filter <?php echo esc_attr( sanitize_title( $layouts_for_elementor_categories ) ); ?>">
						<div class="lfe_box_widget">
							<div class="lfe-media">
								...
								<?php if ( true === $layouts_for_elementor_template['is_pro'] ) { ?>
							...
							<div class="lfe-template-title"><?php echo esc_html( $layouts_for_elementor_template['title'] ); ?></div>
							<div class="lfe-btn">
					...
					<div class="lfe-preview-popup" id="preview-in-<?php echo esc_attr( $layouts_for_elementor_index ); ?>">
						<div class="lfe-preview-container">
							<div class="lfe-preview-header">
								...
								<?php if ( false === $layouts_for_elementor_template['is_pro'] ) { ?>
